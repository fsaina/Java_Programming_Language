...
/**
 * Demo class the the request context class implementation
 */
public class DemoRequestContext {
    ...
    private static void demo2(String filePath, String encoding) throws IOException {
        ...
        rc.addRCCookie(new RCCookie("zgrada", "B4", null, null, "/")); // Only at this point will header be created and written...
        rc.write("Čevapčići i Šiščevapčići.");
        os.close();
    }
}