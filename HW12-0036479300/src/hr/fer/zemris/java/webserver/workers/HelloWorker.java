...
/**
 * Hello worker class abstracting a web worker implementation returning a http page greeting the client user
 */
public class HelloWorker implements IWebWorker {
    ...
    public void processRequest(RequestContext context) {
        ...
        try {
            ...
            System.err.println("Error processing a hello worker request!");
        }
    }
}