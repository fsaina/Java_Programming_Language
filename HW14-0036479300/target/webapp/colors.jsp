...
<table style="width:100%">
    <tr>
        <td>
            ...
            <!--The position of DIV tags is valid, although the eclipse editors says otherwise. The reason they were put here is 
            so I could apply CSS styles to individual table elements-->
