...
/**
 * Ray caster class implementation showcase of the graphical and multitthreading properties of the Java
 * language
 *
 * @author Filip Saina
 */
public class RayCasterParallel {
    ...
    public static class RayTracerProducer implements IRayTracerProducer {
        ...
        /**
         * Thread pool used in the computation
         */
        private ForkJoinPool pool;

        /**
         * Maximal number of lines to be drawn per job on screen
         */
        ...
        public void produce(Point3D eye, Point3D view, Point3D viewUp,
            ...
            pool.invoke(new Job(red, green, blue, zAxis, yAxis, xAxis,
        ...
        private static class Job extends RecursiveAction {
            ...
            /**
             * Minimal y to be calculated
             */
            private int yMin;

            /**
             * Maximum y to be calcualted
             */
            private int yMax;

            /**
             * Default constructor for Job lass.
             */
            public Job(short[] red, short[] green, short[] blue,
            ...
            protected void compute() {
                if (yMax - yMin < MAX_LINES) {
                    ...
                    /*
                     * Divide the rest of jobs to slices
                     */
                    invokeAll(new Job(red, green, blue, zAxis, yAxis, xAxis,
                                    screenCorner, scene, eye, view, viewUp, horizontal,
                                    vertical, width, height, yMin, (yMax + yMin) / 2 - 1),

                            new Job(red, green, blue, zAxis, yAxis, xAxis,
